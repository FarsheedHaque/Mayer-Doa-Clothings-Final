...
if (isset($_POST['register'])) { 
    ...
    $query = query("UPDATE seller SET seller_name = '$_SESSION[name]', seller_phone = '$_SESSION[phone]', seller_dob = '$_SESSION[dob]', email = '$_SESSION['email']' WHERE seller_id = '$_SESSION[seller_id]' ");
